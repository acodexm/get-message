...
describe('format API', () => {
  ...
  describe('formatDate()', () => {
    ...
    it('fallsback and warns when no value is provided', () => {
      ...
      expect(consoleError.calls[0].arguments[0]).toContain('[React Intl] Error formatting date.\nRangeError');
    });
    ...
    describe('options', () => {
      ...
      it('handles missing named formats and warns', () => {
        ...
        expect(formatDate(date, { format })).toBe(df.format(date));
        expect(consoleError.calls.length).toBe(1);
        expect(consoleError.calls[0].arguments[0]).toBe(`[React Intl] No date format named: ${format}`);
      });
  ...
  describe('formatTime()', () => {
    ...
    it('fallsback and warns when no value is provided', () => {
      ...
      expect(consoleError.calls.length).toBe(1);
      expect(consoleError.calls[0].arguments[0]).toContain('[React Intl] Error formatting time.\nRangeError');
    });
    ...
    describe('options', () => {
      ...
      it('handles missing named formats and warns', () => {
        ...
        expect(formatTime(date, { format })).toBe(df.format(date));
        expect(consoleError.calls.length).toBe(1);
        expect(consoleError.calls[0].arguments[0]).toBe(`[React Intl] No time format named: ${format}`);
      });
  ...
  describe('formatRelative()', () => {
    ...
    it('fallsback and warns when no value is provided', () => {
      ...
      expect(consoleError.calls.length).toBe(1);
      expect(consoleError.calls[0].arguments[0]).toContain('[React Intl] Error formatting relative time.\nRangeError');
    });
    ...
    describe('options', () => {
      ...
      it('handles missing named formats and warns', () => {
        ...
        expect(formatRelative(date, { format })).toBe(rf.format(date, { now }));
        expect(consoleError.calls.length).toBe(1);
        expect(consoleError.calls[0].arguments[0]).toBe(`[React Intl] No relative format named: ${format}`);
      });
  ...
  describe('formatNumber()', () => {
    ...
    describe('options', () => {
      ...
      it('fallsback and warns on invalid Intl.NumberFormat options', () => {
        ...
        expect(consoleError.calls.length).toBe(1);
        expect(consoleError.calls[0].arguments[0]).toContain('[React Intl] Error formatting number.\nRangeError');
      });
      ...
      it('handles missing named formats and warns', () => {
        ...
        expect(formatNumber(num, { format })).toBe(nf.format(num));
        expect(consoleError.calls.length).toBe(1);
        expect(consoleError.calls[0].arguments[0]).toBe(`[React Intl] No number format named: ${format}`);
      });
    });
  });
  ...
  describe('formatMessage()', () => {
    ...
    it('throws when no Message Descriptor is provided', () => {
      expect(() => formatMessage()).toThrow('[React Intl] An `id` must be provided to format a message.');
    });
    ...
    it('throws when Message Descriptor `id` is missing or falsy', () => {
      ...
      [undefined, null, false, 0, ''].forEach((id) => {
        expect(() => formatMessage({ id: id })).toThrow('[React Intl] An `id` must be provided to format a message.');
      });
    });
